...
const ThemeIcons = {
    ...
    debug_all: new ThemeIcon('debug_all'),
    ...
    debug_coverage: new ThemeIcon('debug_coverage'),
    ...
    workspace_unknown: new ThemeIcon('workspace-trusted'),
...
const codicons = {
    ...
    workspace_unknown: '$(workspace-trusted)',
